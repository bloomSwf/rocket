package com.rocket.rocket.rocketMq.consumer.processor.listener;
...
import com.rocket.rocket.util.constant.RocketMQErrorEnum;
import com.rocket.rocket.service.MQConsumeService;
import com.rocket.rocket.util.exception.RocketMQException;
...
public class MQConsumeMsgListenerProcessor implements MessageListenerConcurrently{
    ...
    private MQMsgProcessor selectConsumeService(String topic, String tag) {
        ...
        for (Entry<String, MQMsgProcessor> entry : mqMsgProcessorServiceMap.entrySet()) {
            ...
            String annotationTopic = consumeService.topic().getTopic();
